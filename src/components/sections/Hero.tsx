...
export const Hero = () => {
  return (
    <section className="min-h-[90vh] flex flex-col justify-center items-center px-6 py-20 bg-gradient-to-br from-gray-50 to-brand-background text-center animate-fadeInUp">
      <h1 className="text-4xl md:text-[64px] font-bold leading-[1.2] text-brand-text mb-6 max-w-[900px]">
        Turn your website link into a month of <span className="highlight">video ads</span>.<br />
        <span className="block mt-2">In minutes.</span>
      </h1>
      
      <p className="text-base md:text-xl text-brand-textSecondary max-w-[600px] mx-auto mb-10 leading-relaxed">
        No agencies. No filming. No learning curve.
        Just paste your URL. We turn your existing content 
        into professional video & static ads engineered to sell.
      </p>
