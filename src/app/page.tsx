...
import { ArrowRight, Play, Zap, BarChart } from "lucide-react";
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Generate High-Converting Video Ads with AI
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Transform your product details into engaging video content in minutes. Novara analyzes your brand and creates ads that convert.
            </p>
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-3 lg:gap-y-16">
            <div className="relative pl-16">
              ...
              <dd className="mt-2 text-base leading-7 text-gray-600">
                No more waiting weeks for agencies. Get production-quality video ads in minutes.
              </dd>
            </div>
            <div className="relative pl-16">
              <dt className="text-base font-semibold leading-7 text-gray-900">
              ...
              <dd className="mt-2 text-base leading-7 text-gray-600">
                Designed with conversion in mind. Our AI understands what makes viewers click.
              </dd>
            </div>
            <div className="relative pl-16">
              <dt className="text-base font-semibold leading-7 text-gray-900">
              ...
              <dd className="mt-2 text-base leading-7 text-gray-600">
                Optimized formats for TikTok, Instagram Reels, YouTube Shorts, and more.
              </dd>
            </div>
          </dl>
        </div>
